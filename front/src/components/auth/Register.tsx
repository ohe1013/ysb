...
const Register = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.post("/user/login", JSON.stringify({ id: "gosu", password: "1q2w3e4r" }), {
          ...
          <section className="text-gray-600 body-font relative">
            <div className="container px-5 py-24 mx-auto">
              <div className="flex flex-col text-center w-full mb-12">
                <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">회원가입</h1>
              </div>
              ...
              <div className="lg:w-1/2 md:w-2/3 mx-auto">
                <form onSubmit={handleSubmit}>
                  <div className=" -m-2">
                    ...
                    {errMsg !== "" ? (
                      <div className="flex flex-col text-center w-full mb-12">
                        <p className="sm:text-l text-l font-medium title-font mb-4 text-red-500">{errMsg}</p>
                      </div>
                    ) : null}
